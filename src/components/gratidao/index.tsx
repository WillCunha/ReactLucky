    ...
    <View>
        ...
        <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
            <View style={Styles.imageContent}>
                <Image
                    source={require('../../../assets/images/gratidao.png')}
                    resizeMode='contain'
                    style={{ maxWidth: '100%', maxHeight: 400 }} />
            </View>

            <View style={Styles.mainContent}>
                <Text style={[Styles.txtHeader, { fontSize: 30 }]}>{userData?.nome}</Text>
                <Text style={[Styles.txtHeader, { fontSize: 30 }]}>MUITO OBRIGADO!</Text>
            </View>
            ...
            <View style={Styles.mainContent}>
                ...
                <Text></Text>
                <Text style={Styles.txtP}>Antes de continuar, é necessário lembrá-lo que essa é uma versão Beta.
                    Por tanto, pode ser que algo esteja fora do lugar, ou, até mesmo estranho.
                </Text>
                <Text></Text>
                <Text style={Styles.txtP}>Se caso ocorra algo assim, um botão flutuante presente no <Text style={Styles.txtSpan}>canto inferior direito
                    da tela, com o ícone de uma câmera</Text>, fará com que você tire um print da tela ( sem a imagem da barra de notificações )
                    e automaticamente nos envie. A imagem, chegará de forma anônima.
                </Text>
                <Text></Text>
                <Text style={Styles.txtP}>Isso é importante para corrigir aquilo que não foi visto durante a fase alfa.
                </Text>
                <Text></Text>
                <Text style={Styles.txtSpan}>Você pode também entrar em contato por e-mail: suporte@wfsoft.com.br
                </Text>
